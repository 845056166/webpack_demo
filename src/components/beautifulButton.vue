<template>
  <button :class="['button', {'disable': disable}]" v-text="text" @click="clickBtn" :disabled="disable">Button</button>
</template>
<script lang="ts">
import { Component, Prop, Vue, Emit } from 'vue-property-decorator';
@Component
export default class BeautifulButton extends Vue {
    $pop: boolean
    @Prop({ type: String, default: 'button'}) text !: string
...
h2{
  ...
  &.disable {
    ...
    box-shadow: 0 2px 25px rgba(98, 101, 103, .5);
  }
}
